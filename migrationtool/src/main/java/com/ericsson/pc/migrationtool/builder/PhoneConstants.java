...
public class PhoneConstants {
	...
	public static final String SPEC_FEAT_COUNT_LIST_FIELD = "extraFeatureCount";
	...
	public static final String BRAND_ID_VALUE = "boost";
	public static final String MSRP_VALUE = "199";
	public static final String EQP_VALUE = "199";
	public static final String OOS_THRESHOLD_VALUE = "100";	
